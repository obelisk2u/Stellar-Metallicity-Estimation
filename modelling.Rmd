...
predictions_c <- predict(model_c)
residuals_c <- df$mh - predictions_c
squared_residuals_c <- residuals_c^2
mse_c <- mean(squared_residuals_c)
mse_c

#partial pooling
model_p <- lmer(mh ~ d + tmp + mag + l + rad_vel + (1|levels), data = df_norm)
predictions_p <- predict(model_p)
residuals_p <- df$mh - predictions_p
squared_residuals_p <- residuals_p^2
mse_p <- mean(squared_residuals_p)
mse_p

#no pooling
model_n <- lm(mh ~ d + tmp + mag + l + rad_vel + levels - 1, data = df)
predictions_n <- predict(model_n)
residuals_n <- df$mh - predictions_n
squared_residuals_n <- residuals_n^2
mse_n <- mean(squared_residuals_n)
mse_n
